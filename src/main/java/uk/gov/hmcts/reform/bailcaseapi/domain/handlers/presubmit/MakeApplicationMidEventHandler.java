...
//            newBailCase.write(BailCaseFieldDefinition.IS_ADMIN, YesOrNo.YES);
//        } else {
//            newBailCase.write(BailCaseFieldDefinition.IS_ADMIN, YesOrNo.NO);
//        }
//        if (userRoleLabel.equals(UserRoleLabel.LEGAL_REPRESENTATIVE)) {
//            newBailCase.write(BailCaseFieldDefinition.IS_LEGAL_REP, YesOrNo.YES);
//        } else {
//            newBailCase.write(BailCaseFieldDefinition.IS_LEGAL_REP, YesOrNo.NO);
//        }
//        if (userRoleLabel.equals(UserRoleLabel.HOME_OFFICE_GENERIC)) {
//            newBailCase.write(BailCaseFieldDefinition.IS_HOME_OFFICE, YesOrNo.YES);
//        } else {
