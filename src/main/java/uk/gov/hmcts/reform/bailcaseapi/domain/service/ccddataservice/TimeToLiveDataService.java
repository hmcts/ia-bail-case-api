...
public class TimeToLiveDataService extends CcdDataService {
    ...
    public TimeToLiveDataService(FeatureToggler featureToggler,
    ...
    public void updateTheClock(Callback<BailCase> callback, boolean isToBeSuspended) {
        ...
        if (featureToggler.getValue("ia-retain-dispose", false)) {
            ...
            log.info(
                "TTL updated with systemTTL: {}, overrideTTL: {}, suspended: {}",
