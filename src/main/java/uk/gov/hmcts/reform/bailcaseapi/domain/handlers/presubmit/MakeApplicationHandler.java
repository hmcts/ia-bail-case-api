...
//        CaseDetails sss = createCaseForCaseworker(userDetails, callback.getCaseDetails());
//        CaseDetails sss = creatCase(userDetails);
//        var ssss = searchForCaseworker(userDetails);
//        var sadda = ssss;

//        bailCase.clear();
//        bailCase.write(BailCaseFieldDefinition.APPLICANT_GIVEN_NAMES, "test");
//        bailCase.write(BailCaseFieldDefinition.APPLICANT_FAMILY_NAME, "test");
//
//        var newBailCase = new BailCase();
//        newBailCase.write(BailCaseFieldDefinition.APPLICANT_GIVEN_NAMES, "test");
//        newBailCase.write(BailCaseFieldDefinition.APPLICANT_FAMILY_NAME, "test");

        return new PreSubmitCallbackResponse<>(newBailCase);
    }

    public List<CaseDetails> searchForCaseworker(UserDetails caseworker) {
        log.info("Searching cases for citizen");
        Map<String, String> searchCriteria = new HashMap<>();
        searchCriteria.put("state", "decisionDecided");
    ...
    private CaseDetails creatCase(UserDetails caseworker) {
        ...
        var pp = startEventResponse;
        var pp1 = startEventResponse;
    ...
    private CaseDetails createCaseForCaseworker(UserDetails caseworker, uk.gov.hmcts.reform.bailcaseapi.domain.entities.ccd.CaseDetails<BailCase> caseDetails) {
...
//            .event(uk.gov.hmcts.reform.ccd.client.model.Event.builder().id(startEventResponse.getEventId()).build())
//            .data(CREATE_CASE_DATA)
//            .caseReference(String.valueOf(oldCaseId))
//            .build();
//
//        return coreCaseDataApi.submitForCaseworker(
//            caseworker.getAccessToken(),
