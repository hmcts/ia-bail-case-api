...
public class EditAppealHandler implements PreSubmitCallbackHandler<BailCase> {
    ...
    public PreSubmitCallbackResponse<BailCase> handle(
        ...
        Optional<YesOrNo> optionalFinancialSupporter1 = bailCase.read(HAS_FINANCIAL_COND_SUPPORTER, YesOrNo.class);
        Optional<YesOrNo> optionalFinancialSupporter2 = bailCase.read(HAS_FINANCIAL_COND_SUPPORTER_2, YesOrNo.class);
        Optional<YesOrNo> optionalFinancialSupporter3 = bailCase.read(HAS_FINANCIAL_COND_SUPPORTER_3, YesOrNo.class);
        Optional<YesOrNo> optionalFinancialSupporter4 = bailCase.read(HAS_FINANCIAL_COND_SUPPORTER_4, YesOrNo.class);
        Optional<YesOrNo> optionalInterpreterLanguage = bailCase.read(INTERPRETER_YESNO, YesOrNo.class);
        Optional<String> optionalNationality = bailCase.read(APPLICANT_NATIONALITY, String.class);
        Optional<YesOrNo> optionalBailEvidenceDocs = bailCase.read(GROUNDS_FOR_BAIL_PROVIDE_EVIDENCE_OPTION, YesOrNo.class);
        Optional<YesOrNo> optionalLegalRepDetails = bailCase.read(HAS_LEGAL_REP, YesOrNo.class);
        ...
        if (optionalFinancialSupporter2.isPresent()) {
        ...
        if (optionalFinancialSupporter3.isPresent()) {
        ...
        if (optionalFinancialSupporter4.isPresent()) {
