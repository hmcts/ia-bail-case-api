...
public class EditDocsMidEventHandler implements PreSubmitCallbackHandler<BailCase> {
    ...
    public PreSubmitCallbackResponse<BailCase> handle(
        ...
        final PreSubmitCallbackResponse<BailCase> bailCasePreSubmitCallbackResponse = new PreSubmitCallbackResponse<>(bailCase);
            ...
            if (idValuesOptional.isPresent()) {
                for (IdValue<DocumentWithMetadata> documentWithMetadataIdValue : idValuesOptional.get()) {
                    try {
                        ...
                        bailCasePreSubmitCallbackResponse.addError("If you add a new document you must complete the fields related to that document, or remove it, before you can submit your changes.");
